...
export class GameGarland extends HTMLDivElement {
  ...
  render(): void {
    this.insertAdjacentHTML(
      ...
      <label for="garland-1" class="garland_white">
      </label>
      </li>
      <li>
      
      <input id="garland-2" type="radio" name="garland" data-color="yellow">
      <label for="garland-2" class="garland_yellow">
      </label>
      </li>
      <li>
     
      <input id="garland-3" type="radio" name="garland" data-color="red">
      <label for="garland-3" class="garland_red">
      </label>
      </li>

      <li>
      <input id="garland-4" type="radio" name="garland" data-color="blue">
      <label for="garland-4" class="garland_blue">
      </label>
      </li>

      <li>
      <input id="garland-5" type="radio" name="garland" data-color="green">
      <label for="garland-5" class="garland_green">
      </label>
      </li>

      <li>
      <input id="garland-6" type="radio" name="garland" data-color="none" checked>
