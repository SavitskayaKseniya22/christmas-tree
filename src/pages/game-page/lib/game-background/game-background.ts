...
export class GameBackground extends HTMLDivElement {
  ...
  render(): void {
    this.insertAdjacentHTML(
      ...
      <input id="background-1" type="radio" name="background" data-src=${img_1}>
      </label>
      </li>
      ...
      <input id="background-2" type="radio" name="background" data-src=${img_2}>
      </label>
      </li>
      <li>
      <label for="background-3">
      <img src=${img_3} alt="Background" />
      <input id="background-3" type="radio" name="background" data-src=${img_3}>
      </label>
      </li>
      <li>
      <label for="background-4">
      <img src=${img_4} alt="Background" />
      <input id="background-4" type="radio" name="background" data-src=${img_4}>
      </label>
      </li>
      <li>
      <label for="background-5">
      <img src=${img_5} alt="Background" />
      <input id="background-5" type="radio" name="background" data-src=${img_5}>
      </label>
      </li>
      <li>
      <label for="background-6">
      <img src=${img_6} alt="Background" />
      <input id="background-6" type="radio" name="background" data-src=${img_6}>
      </label>
      </li>
      <li>
      <label for="background-7">
      <img src=${img_7} alt="Background" />
      <input id="background-7" type="radio" name="background" data-src=${img_7}>
      </label>
      </li>
      <li>
      <label for="background-8">
      <img src=${img_8} alt="Background" />
      <input id="background-8" type="radio" name="background" data-src=${img_8}>
      </label>
      </li>
      </ul>
    `
